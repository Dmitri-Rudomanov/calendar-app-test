...
import {getAppointment} from '../store/reducer/appointmentReducer'
...
function Calendar() {
    ...
    const { addAppointment,editAppointment,deleteAppointment } = bindActionCreators(actionCreators, dispatch)
